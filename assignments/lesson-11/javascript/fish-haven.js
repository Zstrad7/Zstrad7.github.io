...
weatherSum.open('GET', 'https://api.openweathermap.org/data/2.5/weather?id=5585010&appid=e645b27a21704bcc46696c7157f91494&units=imperial', true);
weatherSum.send();
...
weatherWeek.open('GET', 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=e645b27a21704bcc46696c7157f91494&units=imperial', true);
weatherWeek.send();
...
for(var i = 0; i<Info.length; i++){
    if(Info[i].name == "Fish Haven"){
        ...
        myPicture.src="images/fish-haven-event.jpg";
